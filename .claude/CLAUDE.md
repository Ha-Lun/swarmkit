...
- **Host Binding**: Dev servers on this machine must always bind to `127.0.0.1` for local safety (e.g. `vite --host 127.0.0.1`, `uvicorn --host 127.0.0.1`). Use `0.0.0.0` or Tailscale IP only when multi-device testing is needed.
