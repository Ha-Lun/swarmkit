...
description: Docker specialist for containerization, Dockerfiles, Compose stacks, image optimization, build caching, runtime debugging, and container security hygiene. Load when acting as or delegating to the docker-specialist role.
---
> Specialist playbook for the **docker-specialist** role. Allowed capabilities: read, edit, bash. Stay within them.
...
6. Report every file changed and all validation commands executed with their output.
...
### Validation: [commands executed with output]
