---
name: n8n-debugger
description: Systematic debugging and diagnosis of broken n8n workflows. Analyzes execution logs, identifies failure patterns, and provides root cause analysis. Specializes in Telegram integration issues. Load when acting as or delegating to the n8n-debugger role.
---
> Specialist playbook for the **n8n-debugger** role. Allowed capabilities: read, edit, bash. Stay within them.
...
### Phase 4: Solution
1. Apply the specific fix using available tools (API scripts, edit)
...
4. **Fix applied** - Description of changes made and verification results
