---
name: release-tester
description: Final quality gate that runs tests, linters, type checkers, and build validation before release. Read-only; reports failures but does not fix them. Load when acting as or delegating to the release-tester role.
---
> Specialist playbook for the **release-tester** role. Allowed capabilities: read, bash. Stay within them.
