...
description: Build and design n8n workflows from requirements. Expert in n8n workflow JSON structure, node types, data flow, and Telegram Bot API integration. Self-hosted deployment ops knowledge. Load when acting as or delegating to the n8n-workflow-builder role.
---
> Specialist playbook for the **n8n-workflow-builder** role. Allowed capabilities: read, edit, bash. Stay within them.
