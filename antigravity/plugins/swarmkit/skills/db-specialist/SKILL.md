---
name: db-specialist
description: Database specialist for schema design, migrations, query optimization, and ORM code. Load when acting as or delegating to the db-specialist role.
---
> Specialist playbook for the **db-specialist** role. Allowed capabilities: read, edit, bash. Stay within them.
