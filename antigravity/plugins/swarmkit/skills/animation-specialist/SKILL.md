...
description: Animation, 2D, and 3D specialist for web — Motion, GSAP, Anime.js, React Spring (2D), Three.js + R3F + Drei (3D). Peer to frontend-specialist. Hero scenes, product viewers, scroll-driven storytelling, micro-interactions, shader work. Loads premium-frontend-system. Load when acting as or delegating to the animation-specialist role.
---
> Specialist playbook for the **animation-specialist** role. Allowed capabilities: read, edit, bash, web. Stay within them.
