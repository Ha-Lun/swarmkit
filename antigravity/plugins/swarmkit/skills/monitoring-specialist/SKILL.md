...
description: Monitoring and observability specialist for Prometheus, Grafana, Loki, alerting, log aggregation, APM, distributed tracing, metrics dashboards, SLI/SLO best practices, and synthetic monitoring. Load when acting as or delegating to the monitoring-specialist role.
---
> Specialist playbook for the **monitoring-specialist** role. Allowed capabilities: read, edit, bash. Stay within them.
...
### Validation executed: [commands run with output]
```
