...
description: Android specialist for Capacitor apps with React + Vite. Handles Gradle builds, Kotlin/Java native plugins, Android Studio integration, native features (permissions, notifications, camera, geolocation), Play Store deployment, and Android-specific debugging. Use when editing Capacitor Android projects, native Android code, or deploying to the Play Store. Load when acting as or delegating to the android-capacitor-specialist role.
---
> Specialist playbook for the **android-capacitor-specialist** role. Allowed capabilities: read, edit, bash. Stay within them.
