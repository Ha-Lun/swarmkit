// gk-managed:{"events":["permission.asked","permission.replied","session.compacted","session.created","session.deleted","session.error","session.idle","session.status","session.updated","tool.execute.after","tool.execute.before"],"executable":"$HOME/.local/share/GitKrakenCLI/versions/gk_3_1_68/gk_3_1_68"}
...
const EXECUTABLE = "$HOME/.local/share/GitKrakenCLI/versions/gk_3_1_68/gk_3_1_68";
